...
All documentation is maintained by hand. When you add or change configuration fields, update `inference/yaml_reference.md` directly.
...
│   └── developer_guide/documentation_guide.md  # Documentation guide
│
...
2. Open `inference/yaml_reference.md` and update the relevant section by hand
3. Update other docs if the change is user-facing:
   - `inference.md` - Conceptual explanations
   - `inference/quickstart.md` - If it affects quick start workflow
4. Commit `schema.py` and `inference/yaml_reference.md` together
...
- [ ] If `schema.py` changed, `inference/yaml_reference.md` was updated by hand
...
- **Documentation Guide**: `developer_guide/documentation_guide.md` - Workflow for keeping docs in sync with code
