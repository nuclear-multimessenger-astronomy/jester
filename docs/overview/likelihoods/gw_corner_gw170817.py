"""
Corner plot for GW170817 posterior: data samples vs normalizing-flow samples.
...
Blue shows the original posterior samples (GWTC-1, low-spin prior).  Red shows
samples drawn from the trained normalizing flow, demonstrating how faithfully
the flow reproduces the posterior.
...
FLOW_DIR = _FLOWS_BASE / "gw170817" / "gw170817_gwtc1_lowspin"
DATA_FILE = _DATA_BASE / "gw170817" / "gw170817_gwtc1_lowspin_posterior.npz"
...
fig.suptitle("GW170817 (GWTC-1, low-spin)", fontsize=TITLE_FONTSIZE)
